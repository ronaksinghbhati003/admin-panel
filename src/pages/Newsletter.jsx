            ...
            <div className='w-[100%] p-[20px_10px]'>
                    ...
                    show ?
                        <div className='p-[20px_10px] border rounded-lg  mb-[25px] bg-gray-300 '>
                            <form className='flex items-center gap-[10px]'>
                                <input type='text' className='w-[350px] pl-2 py-[8px] rounded-[5px] bg-[#374151] text-white font-semibold' placeholder='Serach Name' name="newsletter" />
                ...
                <div className=''>
                    <div className='flex justify-between border p-[15px_10px] rounded-lg bg-[#F1F5F9]'>
                        <h1 className='text-[25px] font-semibold'>Newsletters Management</h1>
                        ...
                        <table className='w-[100%]'>
                            <thead className='' bgcolor='#374151'>
                                <tr>
                                    ...
                                    <th className='border p-[10px_10px] text-gray-400 font-normal w-[600px] text-left'> User Info</th>
