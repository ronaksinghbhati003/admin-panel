  ...
  return (
    <>
        ...
        <div className='my-[20px] p-[10px_10px] bg-white rounded-lg w-[100%] border'>
                       <h1 className='p-[10px_10px] text-[25px] font-semibold bg-[#F1F5F9] rounded-lg '>Add Slider</h1>
                       <form className='grid grid-cols-[40%_58%] mt-[10px] gap-[20px]'>
                             <div className=''>
                                  <div className=''>
                                    ...
                                    <input type='file' className='hidden' id="sliderImage" name="categoryImage"/>
                                  </div>
                             ...
                             <div className=''>
                                 <div className='mb-[20px]'>
                                    ...
                                    <input type='text' name="addSliderName" className='w-[100%] border rounded-lg mt-[8px] p-[8px_10px]' placeholder='Category Name' required  />
                                 </div>
                                 <div  className='mb-[20px]'>
                                    <label className='font-semibold'>Order</label>
                                    <input type='text' name="addsliderorder" className='w-[100%] border rounded-lg mt-[8px] p-[8px_10px]' placeholder='Order' required  />
                                 </div>
