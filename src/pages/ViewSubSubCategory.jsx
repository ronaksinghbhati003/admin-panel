                                                           ...
                                                           show ?
                                                               <div className='p-[20px_10px] border rounded-lg  mb-[25px] bg-gray-300 '>
                                                                   <form className='flex items-center gap-[10px]'>
                                                                       <select className='w-[250px] bg-[#374151] text-white p-[8px_10px] rounded-lg' name="subsubCategoryParent">
                                                                          <option>Select Parent Category</option>
                                                                          <option value="men">Men</option>
                                                                          <option value="women">Women</option>
                                                                          <option value="sale">Sale</option>
                                                                       </select>
                                                                       <select className='w-[250px] bg-[#374151] text-white p-[8px_10px] rounded-lg' name="subsubCategory">
                                                                          <option>Select Sub Category</option>
                                                                          <option value="men">Men</option>
                                                                          <option value="women">Women</option>
                                                                          <option value="sale">Sale</option>
                                                                       </select>
                                                                       <input type='text' className='w-[350px] pl-2 py-[8px] rounded-[5px] bg-[#374151] text-white font-semibold' placeholder='Serach Name' name="viewSubSubCategory" />
                                                               ...
                                                               <table className='w-[100%]'>
                                                                   <thead className='' bgcolor='#374151'>
                                                                       <tr>
                                                                           ...
                                                                           <th className='border p-[10px_10px] text-gray-400 font-normal'>Category Name</th>
                                                                   ...
                                                                   <tbody className='' bgcolor="#1F2937">
                                                                       <tr className='text-center'>
                                                                           ...
                                                                           <td className=' p-[30px_10px] text-white text-left'>Men</td> 
                                                                           <td className=' p-[30px_10px] text-gray-400'>Men</td>
                                                                           <td className=' p-[30px_10px] text-gray-400'>Shoes</td>
                                                                       ...
                                                                       <tr className='text-center'>
                                                                           <td className=' p-[30px_10px] text-white'><input type='checkbox' /></td>
                                                                           <td className=' p-[30px_10px] text-white text-left'>Women</td> 
                                                                           <td className=' p-[30px_10px] text-gray-400'>Women</td>
                                                                           <td className=' p-[30px_10px] text-gray-400'>Lehnga</td>
                                                                           <td className=' p-[30px_10px] text-gray-400 flex justify-center'>
                                                                                <img src="https://packshifts.in/images/iso.png" width="40" height="40" />
                                                                           </td>                                           
