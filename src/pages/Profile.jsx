         ...
         <div className='w-full  mt-10 grid grid-cols-[30%_auto] gap-4'>
            <div className=' rounded-lg overflow-hidden self-start'>
               <div className='bg-white py-[30px] flex flex-col gap-[10px] justify-center items-center'>
                  <img className='w-[100px] h-[100px] rounded-[100%]' src="https://wscubetech.co/Assignments/furniture/storage/app/public/uploads/images/users/59c32aee-61e4-4868-b27c-e9339ab54e9a-1670132624.jpg" />
                           ...
                           <div className='flex  gap-[20px]'>
                              ...
                              <div className='basis-[70%]'>
                                 <div className='mb-5'>
                                    ...
                                    <input type='text' name='profileName' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter Name' />
                                 </div>
                                 <div className='mb-5'>
                                    <label className='font-semibold block mb-1'>Email</label>
                                    <input type='email' name='profileEmail' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter Email Address' />
                                 </div>
                                 <div className='mb-5'>
                                    <label className='font-semibold block mb-1'>Mobile Number</label>
                                    <input type='password' name='currentPassword' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter Mobile Number' />
                                 </div>
                              </div>
                     ...
                     <div className='mt-4'>
                        <form>
                           <div className='mb-5'>
                              ...
                              <input type='password' name='currentPassword' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter Current Passowrd' />
                           </div>
                           <div className='mb-5'>
                              <label className='font-semibold block mb-1'>New Password</label>
                              <input type='password' name='newPassword' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter New Passowrd' />
                           </div>
                           <div className='mb-5'>
                              <label className='font-semibold block mb-1'>Confirm Password</label>
                              <input type='password' name='confirmPassword' className='w-full border border-gray-300 p-[5px_10px] rounded-[10px]' placeholder='Enter Confirm Passowrd' />
                           </div>
